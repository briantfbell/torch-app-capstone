// hrhAuth middleware — same as adminAuth, but also enforces that the caller
// has role === 'hrh'. Use this instead of auth on routes that should be
// restricted to hrh users only
//
