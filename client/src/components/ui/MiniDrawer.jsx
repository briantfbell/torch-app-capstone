...
import {BarChart, Dashboard, Logout, RunningWithErrors, Settings} from '@mui/icons-material';
...
const Drawer = styled(MuiDrawer, {shouldForwardProp: (prop) => prop !== 'open'})(({theme}) => ({
    width: drawerWidth, flexShrink: 0, whiteSpace: 'nowrap', boxSizing: 'border-box', variants: [{
        props: ({open}) => open, style: {
    ...
    return (<Box sx={{display: 'flex'}}>
        ...
        <Drawer variant="permanent" open={open}>
            ...
            <List>
                ...
                <ListItem disablePadding sx={{display: 'block'}} onClick={() => navigate('/equipment')}>
                    <ListItemButton>
                        <ListItemIcon>
                            <Dashboard/>
                        </ListItemIcon>
                ...
                <ListItem disablePadding sx={{display: 'block'}} onClick={() => navigate('/shortages')}>
                    <ListItemButton>
                        <ListItemIcon>
                            <RunningWithErrors/>
                        </ListItemIcon>
